...
user1 = User(name='Bob', alias='Bobby', email='bob@gmail.com',
             password='crypto', role_id='1', avatar=None, delete_date=None)
user2 = User(name='Mark', alias='Marky', email='mark@gmail.com',
             password='123', role_id='2', avatar=None, delete_date=None)
user3 = User(name='Maria', alias='Mary', email='maria@gmail.com',
             password='321', role_id='3', avatar=None, delete_date=None)

issue1 = Issue(name='Road accident', user_id='2', category_id='1', location='',
               description='Car crash ...',  open_date='2017/10/25',
               close_date=None, delete_date=None)
issue2 = Issue(name='Road accident', user_id='3', category_id='1', location='',
               description='Bus crash ...', open_date='2016/01/12',
               close_date='2016/01/20', delete_date=None)
issue3 = Issue(name='Dog lost', user_id='3', category_id='3', location='',
               description='Poor puppy is lost', open_date='2017/09/20',
               close_date='2017/09/25', delete_date='2017/09/26')

attachment1 = Attachment(issue_id='1', image_url='some url1', delete_date=None)
attachment2 = Attachment(
    issue_id='2', image_url='some url2', delete_date='2016/01/20')
attachment3 = Attachment(
    issue_id='3', image_url='some url3', delete_date='2017/09/26')

issueHistory1 = IssueHistory(user_id='1', issue_id='1', status_id='1',
                             transaction_date='2017/10/25', delete_date=None)
issueHistory2 = IssueHistory(user_id='1', issue_id='1', status_id='2',
                             transaction_date='2017/10/27', delete_date=None)
issueHistory3 = IssueHistory(user_id='3', issue_id='3', status_id='1',
                             transaction_date='2017/09/20', delete_date=None)
issueHistory4 = IssueHistory(user_id='3', issue_id='3', status_id='2',
                             transaction_date='2017/09/25', delete_date=None)
